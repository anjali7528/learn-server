...
const { checkAttendence, getAllStudents, getStudentByName, studentLogin,
    ...
    previousChats, updateProfile, getAllSubjects, getMarks, getAllplayQuiz, postResult,getResult } = require('../controller/studentController')
...
router.get('/allQuiz',getAllplayQuiz)

router.post('/addResult',postResult)
